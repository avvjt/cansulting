...
export default function Footer() {
  const phrase = ["Let’s make it"];
  const phrase1 = ["*happen!"];
  return (
            ...
            <div className="flex justify-between gap-[16px]">
              <div className="pt-[50px]">
                ...
                <div className="flex flex-col gap-y-[10px]">
                  <LinkHover
                    className="before:h-[1px] after:h-[1px] w-fit paragraph font-medium  capitalize flex flex-col before:bottom-[1px] after:bottom-[1px] sm:text-[14px]"
              ...
              <div className="pt-[50px]">
                ...
                {footernavbarItems.map((item) => (
                  <LinkHover
                    ...
                    title={item.title}
                    href={item.href}
                    className="before:h-[1px] after:h-[1px] w-fit paragraph font-medium text-secondry capitalize flex flex-col before:bottom-[1px] after:bottom-[1px] sm:text-[14px]"
                  />
                ))}
              </div>
              <div className="pt-[50px]">
        ...
        <div className="w-1/2 sm:w-full xm:w-full">
          <Link href={"/"}>
            {/* <Image
							...
							height={70}
						/> */}
            <p className="font-bold text-2xl">Infludity</p>
          </Link>
        </div>
