...
export const serviceProcessItems = [
  ...
  },
  {
    ...
    src: phase3,
    review:
      "Your company didn’t get it right the first time. Maybe the first product failed, a business deal collapsed, or customers didn’t respond as expected. Instead of giving up, you pivoted, learned from mistakes, and refined your approach. That resilience led to your breakthrough, proving that failure is just a step toward success.",
    button: "read",
  },
  {
    id: 4,
    ...
    src: phase4,
    review:
      "Your company identified a gap in the market—a problem no one else was solving. With a unique approach, you created a product/service that disrupted the industry. The journey involved countless experiments, late nights, and unexpected challenges, but today, you’re a leader in your field.",
    button: "read",
  },
  {
    id: 5,
    ...
    src: phase5,
    review:
      "Your company didn’t grow because of fancy marketing or massive investments—it grew because you listened to your customers. Every decision, from product development to customer service, was based on feedback and solving real-world problems. That commitment to people-first business fueled your success.",
    button: "read",
  },
];
...
export const FaqItems = [
  ...
  },
  {
    ...
    title: "Description",
    description:
      "Business Consulting provides comprehensive support to enhance your organization’s efficiency, profitability, and market presence. We analyze your current processes and develop strategies for long-term growth.",
    links: [
      {
        id: 1,
        title: 1,
